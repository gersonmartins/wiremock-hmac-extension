...
class WiremockHmacExtensionTest {
    ...
    static WireMockExtension wm = WireMockExtension.newInstance()
            .options(wireMockConfig()
                    .dynamicPort()
                    .extensions(new HmacTemplateHelperProviderExtension(), new HmacRequestMatcherExtension()))
            .build();
    ...
    void shouldMatchRequestWithValidHmacMatcher() throws IOException, InterruptedException {
        ...
        wm.stubFor(requestMatching("hmac-matcher", com.github.tomakehurst.wiremock.extension.Parameters.one("secret", secret))
